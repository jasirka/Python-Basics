...
#program using enumerate() to display index and value of list elements.
fruits = ("apple", "orange", "banana")
enum_list = enumerate(fruits) 
list = list(enum_list)
print(list)

#program to find the value of the following expression
num_1 = 10
num_2 = 11
...
#program to find the results of the following expressions (True or False)
num_1=7
num_2 = 6
print(f"num_1 < num_2 = {num_1 < num_2}")
print(f"num_1 > num_2 = {num_1 > num_2}")
...
num_1=3
num_2 = 4
print(f"(num_1 < num_2) and (num_1 != num_2) = ({num_1 < num_2}) and ({num_1 != num_2})")
print(f"(num_2 >= num_1) or (num_1 > num_2) = ({num_2 >= num_1}) or ({num_1 > num_2})")
print(f"not(num_1 == num_2) = {not(num_1 == num_2)}")

#Program to find the uotput of the following while loop
i=1
while (i<6):
    i = i + 1 
    print(i)
...
#Program to select the correct option
customer_num =5
invoice_num =1212
print("Invoice No(s):")
...
# Ans: a. INV - 1212  INV - 1215  INV - 1218  INV - 1221  INV - 1224